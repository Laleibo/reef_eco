...
class IngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingredient" do
    assert_difference("Ingredient.count") do
      post ingredients_url, params: { ingredient: { item_id: @ingredient.item_id, name: @ingredient.name, quantity: @ingredient.quantity } }
    end
  ...
  test "should update ingredient" do
    patch ingredient_url(@ingredient), params: { ingredient: { item_id: @ingredient.item_id, name: @ingredient.name, quantity: @ingredient.quantity } }
